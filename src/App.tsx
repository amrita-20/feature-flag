...
function App() {
  ...
  const [enable_product_management, setEnableProductManagement] =
    useState(false);
    ...
    <>
      <main className="main">
        <Panel title="Feature Flagging">
          Feature flagging is a software development practice that allows
          developers to toggle features on and off at runtime.
        </Panel>
        {showProductCatalog && (
          <Panel title="Product Catalog">
            A product catalog is a database of products that are available for
            purchase in an online store. A product catalog is a database of
            products that are available for purchase in an online store. A
            product catalog is a database of products that are available for
            purchase in an online store. A product catalog is a database of
            products that are available for purchase in an online store.
          </Panel>
        )}
